...
//             console.log(valid);
//             if(valid){
//                 const token = jwt.sign({UserName:UserName,UserRole:result.user_role},process.env.SECRET_KEY,{expiresIn:'1h'});
//                 console.log(token);
...
userauth.get('/profile',authenticate,(req,res)=>{
    res.status(200).json({userName:req.UserName,userRole:req.user_role})
})
